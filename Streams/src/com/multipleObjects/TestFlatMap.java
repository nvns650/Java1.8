...
public class TestFlatMap {
	...
	public static void main(String[] args) {
		...
		// first language
		System.out.println(devs.stream().map( x -> x.getLanguages()).flatMap( x -> x.stream()).findFirst().get());
		//persons with languages
		//devs.stream().flatMap(x -> x).forEach(s -> System.out.println(s));
	}
